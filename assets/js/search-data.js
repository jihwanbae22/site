...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/site/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/site/books/";
          },
        ...
        handler: () => {
            ...
            window.location.href = "/site/blog/2025/plotly/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/site/projects/8_project/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/site/assets/pdf/example_pdf.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
